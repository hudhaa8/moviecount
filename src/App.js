...
export default function App() {
  ...
  const INITIAL_MOVIE_LIST = [
    ...
    },
    {
      ...
      name: "HANGOVER",
      summary: "The Hangover is a comedy movie centered around four friends—the groom Doug Billings (Justin Bartha), his soon-to-be brother-in-law Alan Garner (Zach Galifianakis), his two best friends Phil Wenneck (Bradley Cooper) and Stu Price (Ed Helms)—head to Las Vegas for Doug's bachelor party. After a night of alcohol, gambling, and partying, Alan, Stu, and Phil awake the next morning not remembering the events of the prior night. Unable to find Doug, the groomsmen encounter a variety of problems as they retrace their steps in order to find him.",
      rating: "8",
    },
    {
